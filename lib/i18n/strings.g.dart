...
///
/// Built on 2023-09-28 at 01:54 UTC
...
class _StringsMainScreenJa implements _StringsMainScreenEn {
	...
	@override String get signIn => '新規登録';
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'mainScreen.title': return 'title';
			case 'mainScreen.signIn': return 'sign in';
			case 'mainScreen.signOut': return 'sign out';
...
extension on _StringsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'mainScreen.title': return 'タイトル';
			case 'mainScreen.signIn': return '新規登録';
			case 'mainScreen.signOut': return 'ログアウト';
